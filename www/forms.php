    ...
    <form class="col s12" method="post">
        <div class="row">
            ...
            <div class="input-field col s6">
                ...
                <input id="reg-lastname" name="reg-lastname" type="text"  class='<?= $lastname_class ?>' value='<?= $reg_lastname ?>'>
        ...
        <div class="row">
            <div class="input-field col s6">
                ...
                <input id="reg-phone" name="reg-phone" type="tel" class='<?= $telephone_class ?>' value='<?= $reg_telephone ?>'>
            ...
            <div class="input-field col s6">
                ...
                <input id="reg-email" name="reg-email" type="email" class='<?= $email_class ?>' value='<?= $reg_email ?>'>
